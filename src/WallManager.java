...
public class WallManager extends GraphicsGroup {
    ...
    public void generateDoors() {
        ...
        Wall wall2 = new Wall((CANVAS_WIDTH / 3) - SMALLER_SIDE, (CANVAS_HEIGHT / 3) + SMALLER_SIDE, SMALLER_SIDE,
            (2 * CANVAS_HEIGHT / 3) - SMALLER_SIDE);
        ...
        Wall wall4 = new Wall((2 * CANVAS_WIDTH / 3) - SMALLER_SIDE, (2 * CANVAS_HEIGHT / 3) + SMALLER_SIDE,
            SMALLER_SIDE, (CANVAS_HEIGHT / 3) - SMALLER_SIDE);
    ...
    public void generateSimpleMaze() {
        ...
        Wall wall2 = new Wall(0, (2 * CANVAS_HEIGHT / 3) + SMALLER_SIDE, SMALLER_SIDE,
            (CANVAS_HEIGHT / 3) - SMALLER_SIDE);
    ...
    public void generateHarderMaze() {
        ...
        Wall wall4 = new Wall((CANVAS_WIDTH / 3) - SMALLER_SIDE, (CANVAS_HEIGHT / 4) + SMALLER_SIDE, SMALLER_SIDE,
            CANVAS_HEIGHT / 3);

        this.add(wall4);

        Wall wall5 = new Wall(2 * CANVAS_WIDTH / 3, (CANVAS_HEIGHT / 4) + SMALLER_SIDE, SMALLER_SIDE,
            CANVAS_HEIGHT / 3);

        this.add(wall5);

        Wall wall6 = new Wall(2 * CANVAS_WIDTH / 3, (7 * CANVAS_HEIGHT / 12) + SMALLER_SIDE, CANVAS_WIDTH / 3,
            SMALLER_SIDE);
